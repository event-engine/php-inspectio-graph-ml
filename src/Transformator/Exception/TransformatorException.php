...
namespace EventEngine\InspectioGraphMl\Transformator\Exception;

use EventEngine\InspectioGraphMl\Exception\InspectioGraphMlException;

interface TransformatorException extends InspectioGraphMlException
{
}
